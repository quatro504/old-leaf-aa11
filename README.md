...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-leaf-aa11
```

A live public deployment of this template is available at [https://old-leaf-aa11.templates.workers.dev](https://old-leaf-aa11.templates.workers.dev)
